...
const Home = (): JSX.Element => {
  const { t } = useTranslation(["trip", "pages_content", "website"]);
      ...
      >
        ...
        >
          ...
          <Image
            alt={"drawn-arrow"}
            className={
              "hidden md:block absolute bottom-[-2rem] left-[28rem] lg:left-[33rem] w-28 lg:w-36"
            }
            src={drawnArrow}
          />
        </div>
      ...
      >
        ...
        <SizedSection className={"pt-4xl"}>
          <div className={"sm:pl-[2.5vw]"}>
            <TitleLegend>
              {t("pages_content:home.our_partners_legend")}
            </TitleLegend>
            <Title2 className={"text-3xl"}>
              {t("pages_content:home.our_partners_title")}
            </Title2>
          ...
          <div className={"mt-[-8rem] lg:mt-[-6rem]"}>
            ...
            >
              ...
              >
                ...
                >
                  <TitleLegend>
                    {t("pages_content:home.comparator_legend")}
                  </TitleLegend>
                  <Title2>{t("pages_content:home.comparator_title")}</Title2>
                  <p>
                    <Trans>{t("pages_content:home.comparator_content")}</Trans>
                  </p>
                </div>
              </div>
            </div>
